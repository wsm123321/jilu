"""Reconstruct and verify Gate 4 compressed long tables."""
from __future__ import annotations
import hashlib,json
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'results_step4';manifest=json.loads((OUT/'raw_parts_manifest.json').read_text(encoding='utf-8'))['archives']
