"""Deterministically package Gate 4 long tables into verifiable Git parts."""
from __future__ import annotations
import gzip,hashlib,json,shutil,subprocess
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'results_step4';PARTS=OUT/'raw_parts';PARTS.mkdir(exist_ok=True)
